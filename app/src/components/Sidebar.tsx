...
import { AudioLines, Box, Captions, type LucideIcon, Mic, Settings, Volume2, Wand2, Zap, MessageSquare, Users, Folder, Cpu } from 'lucide-react';
...
const tabs: Array<{
  ...
  { id: 'providers', path: '/providers', icon: Cpu, label: 'Providers' },
